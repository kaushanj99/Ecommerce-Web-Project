...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
    ...
    <div class="text-center"><!-- text-center Begin -->
        ...
        <button type="submit" name="submit" class="btn btn-primary" style="border:1px solid black;"><!-- btn btn-primary Begin -->
...
if(isset($_POST['submit'])){
    ...
    if($check_c_old_pass==0){
        ...
        echo "<script>alert('Sorry, your current password is did not matched. Please try again.')</script>";
    ...
    if($c_new_pass!=$c_new_pass_again){
         ...
         echo "<script>alert('Sorry, your new password is did not matched. Please try again.')</script>";
