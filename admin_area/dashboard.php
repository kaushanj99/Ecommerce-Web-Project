                ...
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                <td> 1 </td>
                                <td> tharushasandeepa666@gmail.com </td>
                                <td> 32sa32 </td>
                                <td> 24 </td>
                                <td> 2 </td>
                                <td> Large </td>
        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="admin_images/my%20image.jpg" style="width:200px; height:230px;" alt="admin-thumb-info" class="rounded img-responsive">
                    
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                       
                        <span class="thumb-info-inner"> Kaushan Jayasinghe - </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> Email: </span> kaushanjayasinghe.kj@gmail.com <br/>
                        <i class="fas fa-city"></i> <span> City: </span> Matara <br/>
                        <i class="fa fa-envelope"></i> <span> Contact: </span> 0778788749 <br/>
                    ...
                    <p><!-- p begin -->
                        ...
                        <a href="#"> Kaushan Jayasinghe. </a> <br/>
